...
def worker_required(function=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url='/blog/login'):
    '''
...
def employer_required(function=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url='/blog/login'):
    '''
